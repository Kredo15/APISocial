...
class LogMessages:
    ...
    PROFILE_ERROR_SERVER = "Error server by update profile {user_id}: {errData}"

    FRIEND_SEND_REQUEST = "Friend request sent user: {user_id}"
    FRIEND_RESPONDING_TO_REQUEST = "Friend request {response}: {user_id}"
